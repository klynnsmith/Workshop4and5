  ...
  handleLikeClick(clickEvent) {
      ...
      if (clickEvent.button === 0) {
          ...
          if (this.didUserLike()) {
              ...
              unlikeComment(this.props.feedItemID, 4, this.props.commentID, callbackFunction);
          } else {
              // User clicked 'like' button.
              likeComment(this.props.feedItemID, 4,this.props.commentID, callbackFunction);
          }
      }
  }
             ...
             <Link to={"/profile/" + this.props.author._id}>
              ...
              {this.props.children}
                <br /> <a href="#" onClick={(e) => this.handleLikeClick(e)}>
                  {likeButtonText}
                </a> · <a href="#">Reply </a> · <span className="glyphicon glyphicon-thumbs-up"></span> ({this.state.likeCounter.length}) ·
